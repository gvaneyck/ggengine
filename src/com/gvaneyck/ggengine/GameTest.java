...
public class GameTest {
    ...
    public static Object invokeAction(String action) throws InstantiationException, IllegalAccessException {
        return invokeAction(action, null);
    }

    public static Object invokeAction(String action, Object args) throws InstantiationException, IllegalAccessException {
    ...
    public static void checkEnd() throws Exception {
        boolean result = Boolean.valueOf((Boolean)invokeAction("Rules.checkEnd", null));
        if (result) {
